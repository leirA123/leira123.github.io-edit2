...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    settings : {
      ...
      throttle_delay : 64, // calculation throttling to increase framerate
    ...
    set_expedition_position : function () {
      var self = this;
      $('[' + this.attr_name() + '=fixed-magellan]', self.scope).each(function (idx, el) {
        var expedition = $(this),
            settings = expedition.data('magellan-expedition-init'),
    ...
    update_expedition_positions : function () {
      ...
      $('[' + this.attr_name() + '=fixed-magellan]', self.scope).each(function () {
        var expedition = $(this),
            settings = expedition.data('magellan-expedition-init'),
        ...
        if (window_top_offset + self.settings.fixed_top >= top_offset) {
          ...
          expedition.css({position :'fixed-magellan', top : settings.fixed_top}).addClass('fixed-magellan');
        } else {
          expedition.prev('[' + self.add_namespace('data-magellan-expedition-clone') + ']').remove();
          expedition.attr('style', styles).css('position', '').css('top', '').removeClass('fixed-magellan');
        }
      });
    },
